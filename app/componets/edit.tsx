...
export default function Edit({ nome, status, tamanho, descricao, estoque_id }) {
  ...
  const atualizar = async () => {
    try {
      ...
      const response = await axios.put('https://leoncio-backend.onrender.com/estoque/', {
        estoque_id,
    ...
    useEffect(() => {
        const fetchData = async () => {
            try { 
                const response = await axios.get("https://leoncio-backend.onrender.com/estoque/valores/",
                  {withCredentials: true});
